...
public class CombatHudOverlay implements HudRenderCallback {
    ...
    static {
        ...
        m.put("minecraft:zombie", net.minecraft.util.Identifier.of("craftics", "mob_heads/zombie"));
        m.put("minecraft:husk", net.minecraft.util.Identifier.of("craftics", "mob_heads/husk"));
        m.put("minecraft:drowned", net.minecraft.util.Identifier.of("craftics", "mob_heads/drowned"));
        m.put("minecraft:zombie_villager", net.minecraft.util.Identifier.of("craftics", "mob_heads/zombie_villager"));
        m.put("minecraft:skeleton", net.minecraft.util.Identifier.of("craftics", "mob_heads/skeleton"));
        m.put("minecraft:stray", net.minecraft.util.Identifier.of("craftics", "mob_heads/stray"));
        m.put("minecraft:wither_skeleton", net.minecraft.util.Identifier.of("craftics", "mob_heads/wither_skeleton"));
        m.put("minecraft:bogged", net.minecraft.util.Identifier.of("craftics", "mob_heads/bogged"));
        m.put("minecraft:spider", net.minecraft.util.Identifier.of("craftics", "mob_heads/spider"));
        m.put("minecraft:cave_spider", net.minecraft.util.Identifier.of("craftics", "mob_heads/cave_spider"));
        m.put("minecraft:endermite", net.minecraft.util.Identifier.of("craftics", "mob_heads/endermite"));
        m.put("minecraft:silverfish", net.minecraft.util.Identifier.of("craftics", "mob_heads/silverfish"));
        m.put("minecraft:bee", net.minecraft.util.Identifier.of("craftics", "mob_heads/bee"));
        m.put("minecraft:creeper", net.minecraft.util.Identifier.of("craftics", "mob_heads/creeper"));
        m.put("minecraft:blaze", net.minecraft.util.Identifier.of("craftics", "mob_heads/blaze"));
        m.put("minecraft:ghast", net.minecraft.util.Identifier.of("craftics", "mob_heads/ghast"));
        m.put("minecraft:magma_cube", net.minecraft.util.Identifier.of("craftics", "mob_heads/magma_cube"));
        m.put("minecraft:slime", net.minecraft.util.Identifier.of("craftics", "mob_heads/slime"));
        m.put("minecraft:breeze", net.minecraft.util.Identifier.of("craftics", "mob_heads/breeze"));
        m.put("minecraft:enderman", net.minecraft.util.Identifier.of("craftics", "mob_heads/enderman"));
        m.put("minecraft:ender_dragon", net.minecraft.util.Identifier.of("craftics", "mob_heads/ender_dragon"));
        m.put("minecraft:shulker", net.minecraft.util.Identifier.of("craftics", "mob_heads/shulker"));
        m.put("minecraft:witch", net.minecraft.util.Identifier.of("craftics", "mob_heads/witch"));
        m.put("minecraft:pillager", net.minecraft.util.Identifier.of("craftics", "mob_heads/pillager"));
        m.put("minecraft:vindicator", net.minecraft.util.Identifier.of("craftics", "mob_heads/vindicator"));
        m.put("minecraft:evoker", net.minecraft.util.Identifier.of("craftics", "mob_heads/evoker"));
        m.put("minecraft:vex", net.minecraft.util.Identifier.of("craftics", "mob_heads/vex"));
        m.put("minecraft:illusioner", net.minecraft.util.Identifier.of("craftics", "mob_heads/illusioner"));
        m.put("minecraft:ravager", net.minecraft.util.Identifier.of("craftics", "mob_heads/ravager"));
        m.put("minecraft:piglin", net.minecraft.util.Identifier.of("craftics", "mob_heads/piglin"));
        m.put("minecraft:piglin_brute", net.minecraft.util.Identifier.of("craftics", "mob_heads/piglin_brute"));
        m.put("minecraft:zombified_piglin", net.minecraft.util.Identifier.of("craftics", "mob_heads/zombified_piglin"));
        m.put("minecraft:hoglin", net.minecraft.util.Identifier.of("craftics", "mob_heads/hoglin"));
        m.put("minecraft:zoglin", net.minecraft.util.Identifier.of("craftics", "mob_heads/zoglin"));
        m.put("minecraft:strider", net.minecraft.util.Identifier.of("craftics", "mob_heads/strider"));
        m.put("minecraft:warden", net.minecraft.util.Identifier.of("craftics", "mob_heads/warden"));
        m.put("minecraft:phantom", net.minecraft.util.Identifier.of("craftics", "mob_heads/phantom"));
        m.put("minecraft:guardian", net.minecraft.util.Identifier.of("craftics", "mob_heads/guardian"));
        m.put("minecraft:elder_guardian", net.minecraft.util.Identifier.of("craftics", "mob_heads/elder_guardian"));
        m.put("minecraft:wither", net.minecraft.util.Identifier.of("craftics", "mob_heads/wither"));
        m.put("minecraft:wolf", net.minecraft.util.Identifier.of("craftics", "mob_heads/wolf"));
        m.put("minecraft:ocelot", net.minecraft.util.Identifier.of("craftics", "mob_heads/ocelot"));
        m.put("minecraft:cat", net.minecraft.util.Identifier.of("craftics", "mob_heads/cat"));
        m.put("minecraft:goat", net.minecraft.util.Identifier.of("craftics", "mob_heads/goat"));
        m.put("minecraft:polar_bear", net.minecraft.util.Identifier.of("craftics", "mob_heads/polar_bear"));
        m.put("minecraft:panda", net.minecraft.util.Identifier.of("craftics", "mob_heads/panda"));
        m.put("minecraft:fox", net.minecraft.util.Identifier.of("craftics", "mob_heads/fox"));
        m.put("minecraft:bat", net.minecraft.util.Identifier.of("craftics", "mob_heads/bat"));
        m.put("minecraft:cow", net.minecraft.util.Identifier.of("craftics", "mob_heads/cow"));
        m.put("minecraft:pig", net.minecraft.util.Identifier.of("craftics", "mob_heads/pig"));
        m.put("minecraft:sheep", net.minecraft.util.Identifier.of("craftics", "mob_heads/sheep"));
        m.put("minecraft:chicken", net.minecraft.util.Identifier.of("craftics", "mob_heads/chicken"));
        m.put("minecraft:rabbit", net.minecraft.util.Identifier.of("craftics", "mob_heads/rabbit"));
        m.put("minecraft:mooshroom", net.minecraft.util.Identifier.of("craftics", "mob_heads/mooshroom"));
        m.put("minecraft:camel", net.minecraft.util.Identifier.of("craftics", "mob_heads/camel"));
        m.put("minecraft:sniffer", net.minecraft.util.Identifier.of("craftics", "mob_heads/sniffer"));
        m.put("minecraft:iron_golem", net.minecraft.util.Identifier.of("craftics", "mob_heads/iron_golem"));
        m.put("minecraft:snow_golem", net.minecraft.util.Identifier.of("craftics", "mob_heads/snow_golem"));
        m.put("minecraft:villager", net.minecraft.util.Identifier.of("craftics", "mob_heads/villager"));
        m.put("minecraft:wandering_trader", net.minecraft.util.Identifier.of("craftics", "mob_heads/wandering_trader"));
        m.put("minecraft:dolphin", net.minecraft.util.Identifier.of("craftics", "mob_heads/dolphin"));
        m.put("minecraft:squid", net.minecraft.util.Identifier.of("craftics", "mob_heads/squid"));
        m.put("minecraft:glow_squid", net.minecraft.util.Identifier.of("craftics", "mob_heads/glow_squid"));
        m.put("minecraft:turtle", net.minecraft.util.Identifier.of("craftics", "mob_heads/turtle"));
        m.put("minecraft:cod", net.minecraft.util.Identifier.of("craftics", "mob_heads/cod"));
        m.put("minecraft:salmon", net.minecraft.util.Identifier.of("craftics", "mob_heads/salmon"));
        m.put("minecraft:pufferfish", net.minecraft.util.Identifier.of("craftics", "mob_heads/pufferfish"));
        m.put("minecraft:axolotl", net.minecraft.util.Identifier.of("craftics", "mob_heads/axolotl"));
        m.put("minecraft:frog", net.minecraft.util.Identifier.of("craftics", "mob_heads/frog"));
        m.put("minecraft:tadpole", net.minecraft.util.Identifier.of("craftics", "mob_heads/tadpole"));
        m.put("minecraft:allay", net.minecraft.util.Identifier.of("craftics", "mob_heads/allay"));
        m.put("minecraft:horse", net.minecraft.util.Identifier.of("craftics", "mob_heads/horse"));
        m.put("minecraft:donkey", net.minecraft.util.Identifier.of("craftics", "mob_heads/donkey"));
        m.put("minecraft:mule", net.minecraft.util.Identifier.of("craftics", "mob_heads/mule"));
        m.put("minecraft:skeleton_horse", net.minecraft.util.Identifier.of("craftics", "mob_heads/skeleton_horse"));
        m.put("minecraft:zombie_horse", net.minecraft.util.Identifier.of("craftics", "mob_heads/zombie_horse"));
        m.put("minecraft:llama", net.minecraft.util.Identifier.of("craftics", "mob_heads/llama"));
        m.put("minecraft:parrot", net.minecraft.util.Identifier.of("craftics", "mob_heads/parrot"));
